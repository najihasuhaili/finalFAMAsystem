...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.create')); ?> <?php echo e(trans('cruds.borangPermohonan.title_singular')); ?>

    </div>

    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.borang-permohonans.store")); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="form-group">
                <label class="required" for="nama_pemohon"><?php echo e(trans('cruds.borangPermohonan.fields.nama_pemohon')); ?></label>
                <input class="form-control <?php echo e($errors->has('nama_pemohon') ? 'is-invalid' : ''); ?>" type="text" name="nama_pemohon" id="nama_pemohon" value="<?php echo e(old('nama_pemohon', '')); ?>" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('no_sambungan') ? 'is-invalid' : ''); ?>" type="text" name="no_sambungan" id="no_sambungan" value="<?php echo e(old('no_sambungan', '')); ?>" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('jawatan') ? 'is-invalid' : ''); ?>" type="text" name="jawatan" id="jawatan" value="<?php echo e(old('jawatan', '')); ?>" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('unit_bahagian') ? 'is-invalid' : ''); ?>" type="text" name="unit_bahagian" id="unit_bahagian" value="<?php echo e(old('unit_bahagian', '')); ?>" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('nama_mesyuaarat') ? 'is-invalid' : ''); ?>" type="text" name="nama_mesyuaarat" id="nama_mesyuaarat" value="<?php echo e(old('nama_mesyuaarat', '')); ?>" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('nama_bilik') ? 'is-invalid' : ''); ?>" name="nama_bilik_id" id="nama_bilik_id" required>
                    <?php $__currentLoopData = $nama_biliks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e(old('nama_bilik_id') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('pengerusi') ? 'is-invalid' : ''); ?>" type="text" name="pengerusi" id="pengerusi" value="<?php echo e(old('pengerusi', '')); ?>" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime <?php echo e($errors->has('dari') ? 'is-invalid' : ''); ?>" type="text" name="dari" id="dari" value="<?php echo e(old('dari')); ?>" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime <?php echo e($errors->has('hingga') ? 'is-invalid' : ''); ?>" type="text" name="hingga" id="hingga" value="<?php echo e(old('hingga')); ?>" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('bil_ahli') ? 'is-invalid' : ''); ?>" type="number" name="bil_ahli" id="bil_ahli" value="<?php echo e(old('bil_ahli', '')); ?>" step="1">
    ...
    <input class="form-control <?php echo e($errors->has('status') ? 'is-invalid' : ''); ?>" type="text" name="status" id="status" value="DALAM PROSES" readonly>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PDIE\htdocs\fama_bilikmesyuarat\resources\views/admin/borangPermohonans/create.blade.php ENDPATH**/ ?>
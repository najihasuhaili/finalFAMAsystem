...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.bilik.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.biliks.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="kapasiti">{{ trans('cruds.bilik.fields.kapasiti') }}</label>
                <input class="form-control {{ $errors->has('kapasiti') ? 'is-invalid' : '' }}" type="text" name="kapasiti" id="kapasiti" value="{{ old('kapasiti', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_bilik') ? 'is-invalid' : '' }}" type="text" name="nama_bilik" id="nama_bilik" value="{{ old('nama_bilik', '') }}" required>
